            ...
            <div className="space-y-6 max-w-2xl">
              <div className="space-y-4">
                ...
                <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
                  Leading the renewable energy revolution with premium solar solutions and expert installation services across South India. Over {yearsOfExcellence} years of excellence and innovation.
                </p>
              </div>
            </div>
          </div>
